...
export function useSettingsController({
  ...
  const {
    ...
    providerPendingDelete, providerSaving, saving, setForm,
    ...
    setProviderOAuthFlow, setProviderOAuthResponse, setProviderPendingDelete, visibleProviderKeys,
  } = modelState;
  ...
  const {
    ...
    mcpOAuthPopupBlocked, mcpPresetAction, mcpPresets, mcpPresetsLoading, nanodeskFeatureAction,
    nanodeskFeatureConfirm, nanodeskFeatures, nanodeskFeaturesError, nanodeskFeaturesLoading,
    ...
    setNanodeskFeatureConfirm, setNanodeskFeatures,
    setNanodeskFeaturesError,
  } = systemState;
  const featureCatalog = nanodeskFeatures?.features ?? [];
