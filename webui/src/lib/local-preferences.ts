...
export const LOCAL_PREFS_STORAGE_KEY = "nanodesk-webui.settings-preferences";
export const LOCAL_PREFS_CHANGED_EVENT = "nanodesk-webui.local-preferences-changed";
