...
export function settingsPayload(): SettingsPayload {
  return {
    ...
    docs: {
      version: "0.2.2",
      base_url: "https://nanodesk.wiki/docs/0.2.2",
      chat_apps_url: "https://nanodesk.wiki/docs/0.2.2/getting-started/chat-apps",
      latest_url: "https://nanodesk.wiki/docs/latest",
    },
  };
}
